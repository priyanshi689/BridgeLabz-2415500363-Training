...
Each branch focuses on specific Java concepts, progressing from the basics to advanced topics like **Functional Interfaces**, **Lambda Expressions**, **Exception Handling**, and **Database Connectivity (JDBC)**.  
...
| `collection-framework` | Covers Java Collections — List, Set, Map, and Generics |
| `jdbc` | Implements Java Database Connectivity (JDBC) using MySQL with Statement and PreparedStatement |
...
- Learned **JDBC (Java Database Connectivity)** — connecting Java to **MySQL**  
...
📂 **Branch:** [`jdbc/studentjdbc`](https://github.com/priyanshi689/BridgeLabz-2415500363-Training/tree/jdbc/studentjdbc)  
📅 **Date:** November 10, 2025  

#### **Project Overview:**  
- Built a **menu-driven console application** to manage student records  
- Connected Java to **MySQL Database** using JDBC  
- Performed **Create, Read, Update, and Delete (CRUD)** operations on the `students` table  
- Used **Collections** (`List<Student>`, `Map<Integer, Student>`) to manage and manipulate in-memory data  
- Implemented **sorting**, **searching**, and **filtering** operations using Collections  
- Integrated **Exception Handling** for database errors and invalid inputs  
- Applied **PreparedStatement** to prevent SQL injection  
- Structured code using packages:  
  - `Student.java` – Model class  
  - `StudentDAO.java` – Handles all database queries  
  - `StudentService.java` – Business logic layer  
  - `Main.java` – User interface (menu-based interaction)  

#### **Key Learnings:**  
- Connected **Java applications** with **databases** using JDBC  
- Enhanced data handling using **Collections Framework**  
- Learned real-world **project structuring** and **modular coding**  
- Practiced **error handling**, **clean coding**, and **version control** through Git  
